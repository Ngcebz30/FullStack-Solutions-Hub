...
/**
 * main - The main function to run the typing tutor game
 *
 * Description: The program reads a list of words from a file and displays
 * them one at a time, waiting for the user to type each word before showing
 * the next one. The user has 60 seconds to type as many words as possible.
 * The program then displays the number of words typed, the typing accuracy
